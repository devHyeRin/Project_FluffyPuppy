...
반려동물 쇼핑몰 웹 애플리케이션 (Spring Boot 기반 개인 프로젝트)
...
단순 CRUD 구현에 그치지 않고,  
실제 쇼핑몰에서 발생하는 주요 비즈니스 흐름과 데이터 관계를 이해하며
...
### 1️⃣ 쇼핑몰 핵심 도메인 이해
- 회원, 상품, 장바구니, 주문 도메인을 중심으로
  실제 전자상거래 서비스의 비즈니스 흐름을 고려한 로직 설계

### 2️⃣ 유지보수 가능한 구조 설계
- Controller / Service / Repository 계층 분리
- 기능 변경 시 영향 범위를 최소화할 수 있는 구조 지향

### 3️⃣ 개인 프로젝트 기반 포트폴리오 구축
- 코드 구조 정리 및 README 문서화에 집중
...
- 프로젝트 상태 : 기능 구현 완료 후 리팩토링 및 구조 개선 진행 중
...
- 주문–상품 간 다대다 관계를 중간 테이블로 분리하여 설계
